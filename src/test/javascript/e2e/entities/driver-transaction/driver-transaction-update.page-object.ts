...
export default class DriverTransactionUpdatePage {
  pageTitle: ElementFinder = element(by.id('catchControlPanelApp.driverTransaction.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  areaCodeInput: ElementFinder = element(by.css('input#driver-transaction-areaCode'));
  recordNumberInput: ElementFinder = element(by.css('input#driver-transaction-recordNumber'));
  customerCodeInput: ElementFinder = element(by.css('input#driver-transaction-customerCode'));
  driverCodeInput: ElementFinder = element(by.css('input#driver-transaction-driverCode'));
  debitInput: ElementFinder = element(by.css('input#driver-transaction-debit'));
  creditInput: ElementFinder = element(by.css('input#driver-transaction-credit'));
  narrationInput: ElementFinder = element(by.css('input#driver-transaction-narration'));
  transactionReferenceInput: ElementFinder = element(by.css('input#driver-transaction-transactionReference'));
  transactionCodeInput: ElementFinder = element(by.css('input#driver-transaction-transactionCode'));
  paymentChannelSelect: ElementFinder = element(by.css('select#driver-transaction-paymentChannel'));
  isReversedInput: ElementFinder = element(by.css('input#driver-transaction-isReversed'));
  hashCodeInput: ElementFinder = element(by.css('input#driver-transaction-hashCode'));
  dateCreatedInput: ElementFinder = element(by.css('input#driver-transaction-dateCreated'));
  createdByInput: ElementFinder = element(by.css('input#driver-transaction-createdBy'));
  creatorUserEmailInput: ElementFinder = element(by.css('input#driver-transaction-creatorUserEmail'));
  dateModifiedInput: ElementFinder = element(by.css('input#driver-transaction-dateModified'));
  modifiedByInput: ElementFinder = element(by.css('input#driver-transaction-modifiedBy'));
  modifierUserEmailInput: ElementFinder = element(by.css('input#driver-transaction-modifierUserEmail'));
