...
export const RatingDeleteDialog = (props: IRatingDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="catchControlPanelApp.rating.delete.question">
        <Translate contentKey="catchControlPanelApp.rating.delete.question" interpolate={{ id: ratingEntity.id }}>
