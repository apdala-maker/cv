...
export const DeviceDeleteDialog = (props: IDeviceDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="catchControlPanelApp.device.delete.question">
        <Translate contentKey="catchControlPanelApp.device.delete.question" interpolate={{ id: deviceEntity.id }}>
