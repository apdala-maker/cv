...
export const ApplicationUserDeleteDialog = (props: IApplicationUserDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="catchControlPanelApp.applicationUser.delete.question">
        <Translate contentKey="catchControlPanelApp.applicationUser.delete.question" interpolate={{ id: applicationUserEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-applicationUser" color="danger" onClick={confirmDelete}>
