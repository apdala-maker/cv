...
export const CountryDeleteDialog = (props: ICountryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="catchControlPanelApp.country.delete.question">
        <Translate contentKey="catchControlPanelApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
