...
export const LocationDataDeleteDialog = (props: ILocationDataDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="catchControlPanelApp.locationData.delete.question">
        <Translate contentKey="catchControlPanelApp.locationData.delete.question" interpolate={{ id: locationDataEntity.id }}>
          Are you sure you want to delete this LocationData?
        </Translate>
      </ModalBody>
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-locationData" color="danger" onClick={confirmDelete}>
