...
export const CompanyDeleteDialog = (props: ICompanyDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="catchControlPanelApp.company.delete.question">
        <Translate contentKey="catchControlPanelApp.company.delete.question" interpolate={{ id: companyEntity.id }}>
